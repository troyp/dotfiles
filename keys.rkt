...
;; Warning: user defined c:x; prefix bindings interfere with builtin c:x; bindings
(keybind-toplevel-cmd "m:-" close-current-tab)
(keybind-toplevel-cmd "m:=" create-new-tab)
;; (rebind "menu" "mouse-popup-menu")
(menu-bind "c:.;c:c" "Quit")
(rebind "m:o" "shift-focus")
(menu-bind "m:r" "Revert")
(menu-bind "m:h;p" "Preferences...")
(menu-bind "m:h;k" "Show Active Keybindings")
(keybinding "c:.;c:d" (λ (ed evt) (send-toplevel-form ed #f)))
(keybinding "c:.;c:e" (λ (ed evt) (send-form ed #f)))
(keybinding "c:.;c:r" (λ (ed evt) (send-selection ed #f)))
