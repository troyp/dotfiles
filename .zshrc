...
bindkey -a -s '^X^D^B' "icd ~/ebooks/\n"
bindkey -v -s '^X^D^[' "cd ~/code/\n"
bindkey -a -s '^X^D^[' "icd ~/code/\n"
bindkey -v -s '^X^D^D' "cd ~/dotfiles/\n"
bindkey -a -s '^X^D^D' "icd ~/dotfiles/\n"
bindkey -v -s '^X^D^E^E' "cd ~/.emacs.d/private/\n"
bindkey -a -s '^X^D^E^E' "icd ~/.emacs.d/private/\n"
bindkey -v -s '^X^D^E^L' "cd /usr/local/share/emacs/26.1/lisp/emacs-lisp\n"
bindkey -a -s '^X^D^E^L' "icd /usr/local/share/emacs/26.1/lisp/emacs-lisp\n"
bindkey -v -s '^X^D^G' "cd ~/.config\n"
bindkey -a -s '^X^D^G' "icd ~/.config\n"
bindkey -v -s '^X^D^H' "cd ~/\n"
bindkey -a -s '^X^D^H' "icd ~/\n"
bindkey -v -s '^X^D^I' "cd ~/Pictures\n"
bindkey -a -s '^X^D^I' "icd ~/Pictures\n"
bindkey -v -s '^X^D^K' "cd ~/bookmarks/\n"
bindkey -a -s '^X^D^K' "icd ~/bookmarks/\n"
bindkey -v -s '^X^D^L' "cd ~/.local/\n"
bindkey -a -s '^X^D^L' "icd ~/.local/\n"
bindkey -v -s '^X^D^O^O' "cd /opt/\n"
bindkey -a -s '^X^D^O^O' "icd /opt/\n"
bindkey -v -s '^X^D^O^B' "cd /opt/bin/\n"
bindkey -a -s '^X^D^O^B' "icd /opt/bin/\n"
bindkey -v -s '^X^D^O^D' "cd /opt/doc/\n"
bindkey -a -s '^X^D^O^D' "icd /opt/doc/\n"
bindkey -v -s '^X^D^O^F' "cd /opt/ff-addons/\n"
bindkey -a -s '^X^D^O^F' "icd /opt/ff-addons/\n"
bindkey -v -s '^X^D^O^I' "cd /opt/info/\n"
bindkey -a -s '^X^D^O^I' "icd /opt/info/\n"
bindkey -v -s '^X^D^O^M' "cd /opt/man/\n"
bindkey -a -s '^X^D^O^M' "icd /opt/man/\n"
bindkey -v -s '^X^D^O^S' "cd /opt/scripts/\n"
bindkey -a -s '^X^D^O^S' "icd /opt/scripts/\n"
bindkey -v -s '^X^D^O^U' "cd /opt/userscripts/\n"
bindkey -a -s '^X^D^O^U' "icd /opt/userscripts/\n"
bindkey -v -s '^X^D^O^Y' "cd /opt/userstyles/\n"
bindkey -a -s '^X^D^O^Y' "icd /opt/userstyles/\n"
bindkey -v -s '^X^D^P' "cd ~/.pentadactyl/\n"
bindkey -a -s '^X^D^P' "icd ~/.pentadactyl/\n"
bindkey -v -s '^X^D^R' "cd ~/repos/\n"
bindkey -a -s '^X^D^R' "icd ~/repos/\n"
bindkey -v -s '^X^D^S' "cd ~/.scripts/\n"
bindkey -a -s '^X^D^S' "icd ~/.scripts/\n"
bindkey -v -s '^X^D^T' "cd ~/tools/\n"
bindkey -a -s '^X^D^T' "icd ~/tools/\n"
bindkey -v -s '^X^D^U^U' "cd /usr/\n"
bindkey -a -s '^X^D^U^U' "icd /usr/\n"
bindkey -v -s '^X^D^U^B' "cd /usr/bin/\n"
bindkey -a -s '^X^D^U^B' "icd /usr/bin/\n"
bindkey -v -s '^X^D^U^L^L' "cd /usr/local/\n"
bindkey -a -s '^X^D^U^L^L' "icd /usr/local/\n"
bindkey -v -s '^X^D^U^L^B' "cd /usr/local/bin/\n"
bindkey -a -s '^X^D^U^L^B' "icd /usr/local/bin/\n"
bindkey -v -s '^X^D^U^S' "cd /usr/share/\n"
bindkey -a -s '^X^D^U^S' "icd /usr/share/\n"
bindkey -v -s '^X^D^Y' "cd ~/.tridactyl/\n"
bindkey -a -s '^X^D^Y' "icd ~/.tridactyl/\n"
bindkey -v -s '^X^D^Z' "cd ~/.oh-my-zsh/custom/\n"
bindkey -a -s '^X^D^Z' "icd ~/.oh-my-zsh/custom/\n"
